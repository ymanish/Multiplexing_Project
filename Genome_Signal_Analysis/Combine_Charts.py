...
absolute_gc = pd.read_csv(Results_path+"\Files\/absolute_gc_content.csv")
absolute_gc.drop(['Unnamed: 0'], axis=1, inplace=True)

element_densities = pd.read_csv(Results_path+"\Files\elements_density.csv")
...
Inter_Regional_Chart2 = pd.read_csv(Results_path+'\Files\Avg_GC_per_element.csv')
...
fig.tight_layout()
plt.savefig(Results_path+'\Charts\combine.png')
...
fig.tight_layout()
plt.savefig(Results_path+'\Charts\combine_1.png')
